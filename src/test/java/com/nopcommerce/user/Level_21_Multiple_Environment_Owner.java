...
public class Level_21_Multiple_Environment_Owner extends BaseTest{
	Environments evironments;
	
	//Run multiple environment by TestNG parameters
	...
	public void beforeClass(String browserName, String environmentName) {
		...
		System.out.println(evironments.appPass());
		System.out.println(evironments.dbHost());
		System.out.println(evironments.dbUser());
		System.out.println(evironments.dbPass());
